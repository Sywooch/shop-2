...
/******/ 	var hotCurrentHash = "3556267f8064638f2ea2"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports) {
	...
	$('.show-sidebar-list').click(function () {
	  var currentList = $(this).next('.products');
	  ...
	  if (currentList.hasClass('opened-sidebar-list')) {
	    ...
	    $('.opened-sidebar-list').removeClass('opened-sidebar-list').slideUp();
	    $('.show-sidebar-list').removeClass('show-sidebar-list_up');
