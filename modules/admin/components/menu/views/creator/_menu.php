...
<div class="row" id="container-nav">
  <nav class="navbar navbar-default" style="background-color: #ececec;">
...
<!--            <a class="navbar-brand" href="#">L</a>-->
          ...
          <div id="navbar" class="navbar-collapse collapse pceuropa-menu" style="display: flex!important; justify-content: center;">
            <ul id="left" class="nav navbar-nav"></ul>
            <ul id="right" class="nav navbar-nav navbar-right" style="border: none;"></ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
  </nav>
